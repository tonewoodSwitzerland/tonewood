...
class Countries {
  ...
  static final List<Country> allCountries = [
    ...
    const Country(name: "Brunei", nameEn: "Brunei Darussalam", code: "BN"),
    ...
    // === ZUSÄTZLICHE EINTRÄGE (alphabetisch nach deutschem Namen) ===

    const Country(name: "Åland", nameEn: "Åland Islands", code: "AX"),
    const Country(name: "Amerikanisch-Samoa", nameEn: "American Samoa", code: "AS"),
    const Country(name: "Amerikanische Jungferninseln", nameEn: "U.S. Virgin Islands", code: "VI"),
    const Country(name: "Anguilla", nameEn: "Anguilla", code: "AI"),
    const Country(name: "Antarktis", nameEn: "Antarctica", code: "AQ"),
    const Country(name: "Aruba", nameEn: "Aruba", code: "AW"),
    const Country(name: "Bermuda", nameEn: "Bermuda", code: "BM"),
    const Country(name: "Bonaire, Sint Eustatius und Saba", nameEn: "Bonaire, Sint Eustatius and Saba", code: "BQ"),
    const Country(name: "Bouvetinsel", nameEn: "Bouvet Island", code: "BV"),
    const Country(name: "Britische Jungferninseln", nameEn: "British Virgin Islands", code: "VG"),
    const Country(name: "Britisches Territorium im Indischen Ozean", nameEn: "British Indian Ocean Territory", code: "IO"),
    const Country(name: "Caymaninseln", nameEn: "Cayman Islands", code: "KY"),
    const Country(name: "Curaçao", nameEn: "Curaçao", code: "CW"),
    const Country(name: "Falklandinseln", nameEn: "Falkland Islands", code: "FK"),
    const Country(name: "Färöer", nameEn: "Faroe Islands", code: "FO"),
    const Country(name: "Französisch-Guayana", nameEn: "French Guiana", code: "GF"),
    const Country(name: "Französisch-Polynesien", nameEn: "French Polynesia", code: "PF"),
    const Country(name: "Französische Süd- und Antarktisgebiete", nameEn: "French Southern Territories", code: "TF"),
    const Country(name: "Gibraltar", nameEn: "Gibraltar", code: "GI"),
    const Country(name: "Grönland", nameEn: "Greenland", code: "GL"),
    const Country(name: "Guadeloupe", nameEn: "Guadeloupe", code: "GP"),
    const Country(name: "Guam", nameEn: "Guam", code: "GU"),
    const Country(name: "Guernsey", nameEn: "Guernsey", code: "GG"),
    const Country(name: "Heard und McDonaldinseln", nameEn: "Heard Island and McDonald Islands", code: "HM"),
    const Country(name: "Hongkong", nameEn: "Hong Kong", code: "HK"),
    const Country(name: "Insel Man", nameEn: "Isle of Man", code: "IM"),
    const Country(name: "Jersey", nameEn: "Jersey", code: "JE"),
    const Country(name: "Kokosinseln", nameEn: "Cocos (Keeling) Islands", code: "CC"),
    const Country(name: "Macau", nameEn: "Macao", code: "MO"),
    const Country(name: "Martinique", nameEn: "Martinique", code: "MQ"),
    const Country(name: "Mayotte", nameEn: "Mayotte", code: "YT"),
    const Country(name: "Montserrat", nameEn: "Montserrat", code: "MS"),
    const Country(name: "Neukaledonien", nameEn: "New Caledonia", code: "NC"),
    const Country(name: "Niue", nameEn: "Niue", code: "NU"),
    const Country(name: "Norfolkinsel", nameEn: "Norfolk Island", code: "NF"),
    const Country(name: "Nördliche Marianen", nameEn: "Northern Mariana Islands", code: "MP"),
    const Country(name: "Palästina", nameEn: "Palestine", code: "PS"),
    const Country(name: "Pitcairninseln", nameEn: "Pitcairn Islands", code: "PN"),
    const Country(name: "Puerto Rico", nameEn: "Puerto Rico", code: "PR"),
    const Country(name: "Réunion", nameEn: "Réunion", code: "RE"),
    const Country(name: "Saint-Barthélemy", nameEn: "Saint Barthélemy", code: "BL"),
    const Country(name: "Saint-Martin (französischer Teil)", nameEn: "Saint Martin (French part)", code: "MF"),
    const Country(name: "Saint-Pierre und Miquelon", nameEn: "Saint Pierre and Miquelon", code: "PM"),
    const Country(name: "Sint Maarten (niederländischer Teil)", nameEn: "Sint Maarten (Dutch part)", code: "SX"),
    const Country(name: "St. Helena, Ascension und Tristan da Cunha", nameEn: "Saint Helena, Ascension and Tristan da Cunha", code: "SH"),
    const Country(name: "Südgeorgien und die Südlichen Sandwichinseln", nameEn: "South Georgia and the South Sandwich Islands", code: "GS"),
    const Country(name: "Svalbard und Jan Mayen", nameEn: "Svalbard and Jan Mayen", code: "SJ"),
    const Country(name: "Tokelau", nameEn: "Tokelau", code: "TK"),
    const Country(name: "Turks- und Caicosinseln", nameEn: "Turks and Caicos Islands", code: "TC"),
   const Country(name: "Wallis und Futuna", nameEn: "Wallis and Futuna", code: "WF"),
    const Country(name: "Weihnachtsinsel", nameEn: "Christmas Island", code: "CX"),
    const Country(name: "Westsahara", nameEn: "Western Sahara", code: "EH"),
  ];
